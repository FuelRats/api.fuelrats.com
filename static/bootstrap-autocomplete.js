...
$(function () {
  let limit = 10
  let autocompleteFields = document.querySelectorAll('[data-autocomplete]')

  _.forEach(autocompleteFields, function (autocompleteField) {
      ...
      Promise.all(requests)
        ...
        .then(function (responses) {
          ...
          if (responseData.length) {
            ...
            responseData.forEach(function (datum) {
              var element
