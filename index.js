...
router.put('/rats/:id', auth.isAuthenticated, rat.put)
router.delete('/rats/:id', auth.isAuthenticated, Permission.required('rat.delete'), rat.delete)

router.get('/rescues', rescue.get)
router.post('/rescues', auth.isAuthenticated, rescue.post)
router.get('/rescues/:id', rescue.getById)
router.put('/rescues/:id', auth.isAuthenticated, rescue.put)
router.put('/rescues/:id/addquote', auth.isAuthenticated, rescue.addquote)
router.put('/rescues/:id/assign/:ratId', auth.isAuthenticated, rescue.assign)
router.put('/rescues/:id/unassign/:ratId', auth.isAuthenticated, rescue.unassign)
router.put('/rescues/:id/unassign/:ratId', auth.isAuthenticated, Permission.required('rescue.delete'), rescue.unassign)

router.get('/users', auth.isAuthenticated, Permission.required('user.read'), user.get)
router.get('/users/:id', auth.isAuthenticated, Permission.required('user.read'), user.getById)
router.put('/users/:id', auth.isAuthenticated, user.put)
router.post('/users', auth.isAuthenticated, user.post)
router.delete('/users/:id', auth.isAuthenticated, Permission.required('user.delete'), user.delete)

router.get('/clients', auth.isAuthenticated, Permission.required('client.read'), client.get)
router.put('/clients/:id', auth.isAuthenticated, Permission.required('client.read'), client.put)
router.post('/clients', auth.isAuthenticated, Permission.required('self.client.create'), client.post)
router.delete('/clients/:id', auth.isAuthenticated, Permission.required('client.delete'), client.delete)
